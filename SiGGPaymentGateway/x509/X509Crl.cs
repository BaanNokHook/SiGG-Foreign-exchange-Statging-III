...
using MySiGGPayment.Org.BouncyCastle.Asn1.Utilities;
...
using MySiGGPayment.Org.BouncyCastle.X509.Extension;
using MySiGGPayment.Org.BouncyCastle.Crypto.Operators;

namespace MySiGGPayment.Org.BouncyCastle.X509
{
	/**
